export const cs = {
  ...
  correlation: {
    ...
    legend_popover: 'Statistická průkaznost: *** = silná (p<0,01), ** = průkazná (p<0,05), * = náznak (p<0,1), ~ = slabá (p<0,2). d = Cohenovo d (míra účinku) — kladné d znamená lepší náladu. Klikni na řádek pro zvýraznění.',
  ...
  screenTime: {
    ...
    refresh: 'Obnovit',
    refreshing: 'Obnovuji…',
    refresh_hint: 'Přeposlat statistiky posledních 7 dní z telefonu',
  ...
  advanced_stats: {
    ...
    legend_mood: 'Každý sloupec ukazuje, kolik dní v posledních 30 dnech jsi měl danou náladu. Klikni na sloupec pro detail.',
    legend_activity: 'Průměrná nálada ve dnech, kdy jsi dělal danou aktivitu. Zelená = lepší nálada, žlutá = neutrální, červená = horší. Klikni na řádek pro detail.',
    legend_trends: 'Sloupce = denní nálada, indigo tečka = 7denní klouzavý průměr. Klikni na den pro detail.',
    legend_scales: 'Rozložení hodnot jednotlivých škál za posledních 30 dní. Klikni na škálu pro zvýraznění.',
    days: '{count} dní',
    percent: '{pct} %',
    avg_mood: 'Průměrná nálada',
    best_day_with: 'Nejlepší den s aktivitou',
    worst_day_with: 'Nejhorší den s aktivitou',
    no_activities: 'Zatím žádné aktivity v posledních 30 dnech',
  },
};
